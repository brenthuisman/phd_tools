...
ax4.axhline(2.77, color='indianred', ls='-',lw=lw)#, alpha=0.5)
ax2.axhline(4.08, color='indianred', ls='-',lw=lw)#, alpha=0.5)
ax5.axhline(4.08, color='indianred', ls='-',lw=lw)#, alpha=0.5)
ax3.axhline(12.4, color='indianred', ls='-',lw=lw)#, alpha=0.5)
ax6.axhline(12.4, color='indianred', ls='-',lw=lw)#, alpha=0.5)
...
ax1.errorbar(X,Y,yerr=Yd,color='black',fmt='.',lw=lw,capsize=5, markeredgewidth=lw)
ax1.semilogx()
...
ax2.errorbar(X,Y,yerr=Yd,color='black',fmt='.',lw=lw,capsize=5, markeredgewidth=lw)
ax2.semilogx()
...
ax3.errorbar(X,Y,yerr=Yd,color='black',fmt='.',lw=lw,capsize=5, markeredgewidth=lw)
ax3.semilogx()
...
ax4.errorbar(X,Y,yerr=Yd,color='black',fmt='.',lw=lw,capsize=5, markeredgewidth=lw)
ax4.semilogx()
...
ax5.errorbar(X,Y,yerr=Yd,color='black',fmt='.',lw=lw,capsize=5, markeredgewidth=lw)
ax5.semilogx()
...
ax6.errorbar(X,Y,yerr=Yd,color='black',fmt='.',lw=lw,capsize=5, markeredgewidth=lw)
ax6.semilogx()
