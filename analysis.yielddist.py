...
for fp in sources:
	...
	if 'source.mhd' in fp:
		row['pg']
	elif 'dosedist-Dose.mhd' not in fp:

	elif 'dosedist-Dose-Squared.mhd' not in fp:
	...
	if 'run.jBhF/group10' in fp:
		row['nprim'] = int(1e7)
		row['type'] = 'analog'
	if 'run.pO5k/group10f10' in fp:
		row['nprim'] = int(1e8)
		row['type'] = 'analog'
	if 'run.pO5k/group100' in fp:
		row['nprim'] = int(1e9)
		row['type'] = 'analog'
